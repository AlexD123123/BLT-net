...
#ALFNet learns to predict the center of the target relatively to the anchor (normalized by the anchor width/height
# and the width/height ratio from the anchor width/height (log scale)
...
#get predicted bboxes using the real anchors (boxes) and the predicted deltas from them
