...
class Params:
	...
	def setDetParams(self):
		...
		self.recThrs = np.linspace(0, 1, 100 + 1, endpoint=True)
		...
		#big pedestrians
		#self.HtRng = [[500, 50000], [500, 10000], [500, 10000], [500, 10000]]
		print('Heights range: {}/{}/{}/{}'.format(self.HtRng[0], self.HtRng[1], self.HtRng[2], self.HtRng[3]))
